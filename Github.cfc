component setter="false" getter="false" {
    ...
    public function init(
        ...
        this.repositories = arguments.repositories ? new components.github.repositories(token=this.token) : {};
        ...
        this.webhooks = arguments.webhooks ? new components.github.webhooks(org=arguments.organizationName, token=this.token) : {};
